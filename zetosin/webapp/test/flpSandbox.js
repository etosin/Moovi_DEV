		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Companhias Aéras",
									"targetURL": "#moovizetosin-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"moovizetosin-display": {
								"semanticObject": "moovizetosin",
								"action": "display",
								"description": "List Detail Fiori Freestyle",
								"title": "Companhias Aéras",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=moovi.zetosin",
									"url": sap.ui.require.toUrl("moovi/zetosin")
								}
							}
						}
					}
