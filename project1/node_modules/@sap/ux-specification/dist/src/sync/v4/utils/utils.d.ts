 ...
 */
export declare function addLineItemsTypeToSchema(data: LineItemDataForSchema, columnDefinitionName?: string, customColumnDefinitionName?: DefinitionName, customActionDefinitionName?: DefinitionName): void;
/**
