 ...
 */
function addLineItemsTypeToSchema(data, columnDefinitionName = ux_specification_types_1.DefinitionName.TableColumn, customColumnDefinitionName, customActionDefinitionName) {
...
function addCustomFilterFieldDefinition(appSchema, definition, v4Page) {
    ...
    // check for already defined section
    const selectionFieldsEntry = v4Page.options?.settings?.controlConfiguration?.['@com.sap.vocabularies.UI.v1.SelectionFields'];
