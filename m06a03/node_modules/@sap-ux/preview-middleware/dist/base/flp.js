...
class FlpSandbox {
    ...
    init(manifest, componentId, resources = {}) {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            this.templateConfig = {
                basePath: (_d = (0, path_1.relative)((0, path_1.dirname)(this.config.path), '/')) !== null && _d !== void 0 ? _d : '.',
                apps: {},
                ui5: {
            ...
            this.addApp(manifest, {
                componentId,
                target: (_j = resources[componentId !== null && componentId !== void 0 ? componentId : manifest['sap.app'].id]) !== null && _j !== void 0 ? _j : this.templateConfig.basePath,
                local: '.',
            ...
            if (editor.developerMode) {
                ...
                this.router.get(editor.path, (_req, res) => {
                    ...
                    const html = (0, ejs_1.render)(template, {
                        ...
                        telemetry: (_b = (_a = rta.options) === null || _a === void 0 ? void 0 : _a.telemetry) !== null && _b !== void 0 ? _b : false
                    });
